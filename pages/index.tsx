		...
		>
			...
			<main className="flex flex-1 w-full flex-col items-center text-center px-4 mt-12 sm:mt-10">
				<a
					className={`${
						mode === "dark"
							? "bg-[#151515] text-white shadow-sm shadow-white hover:bg-[#111111] "
							: ""
					} flex max-w-fit items-center justify-center space-x-2 rounded-full border border-gray-300 px-4 py-2 text-sm shadow-md transition-colors hover:bg-gray-100  mb-5`}
				...
				<h1
					...
					}sm:text-6xl text-4xl max-w-2xl font-bold text-slate-900`}
				>
				...
				<h2
					className={`${
						mode === "dark" ? " text-white " : ""
					}sm:text-4xl text-4xl max-w-2xl font-bold text-slate-900  sm:mt-4`}
				>
								...
								<>
									<div>
										<h2
											className={`${
												mode === "dark" ? " text-white  " : ""
											}sm:text-2xl text-2xl text-gray-500 font-normal mx-auto`}
										>
